...
Section 1: how to compile
	...
	2. use the command "java -jar CS4432_Project3_lrtrujillo.jar" to run the program
	
	If you wish to compile the files. Please do "javac CS4432_Project3_lrtrujillo.java". This may be
